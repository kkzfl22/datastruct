 ...
 * @version 0.0.1
 */
public class TestMergeRepetitionData {
  ...
  public void testMergeData() {
    ...
    try {
      DataParseInf<FileDataEntity> parse = TestBigFileCompare.getDataParse();

      MergeRepetitionData instance =
          new MergeRepetitionData(FileDataEntity.class, src, target, parse);
      instance.merge();
