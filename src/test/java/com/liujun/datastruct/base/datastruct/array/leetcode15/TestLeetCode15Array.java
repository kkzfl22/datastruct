 ...
 * @date 2019/07/15
 */
public class TestLeetCode15Array {

  @Test
  public void test() {
    int[] array = new int[] {-1, 0, 1, 2, -1, -4, 4};

    List<List<Integer>> arrays = CountSumThirdNumArraysTwo.INSTANCE.threeSum(array);
  ...
  public void test2() {
    ...
    List<List<Integer>> arrays = CountSumThirdNumArrays.INSTANCE.threeSum(array);
