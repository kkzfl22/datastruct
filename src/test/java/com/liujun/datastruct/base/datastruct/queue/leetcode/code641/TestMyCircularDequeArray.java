 ...
 * @date 2019/08/25
 */
public class TestMyCircularDequeArray {

  @Test
  public void testQueueHead() {
    int size = 10;
    MyCircularDequeArray queue = new MyCircularDequeArray(size);
  ...
  @Test
  public void explame() {
    MyCircularDequeArray circularDeque = new MyCircularDequeArray(3); // 设置容量大小为3
    ...
    Assert.assertEquals(false, circularDeque.isEmpty());
