 ...
 * @date 2019/08/16
 */
public class TestSolutionCalculator {

  private SolutionCalculator instance = new SolutionCalculator();

  @Test
  public void testcalculate() {

    Assert.assertEquals(7, instance.calculate("3+2*2"));
    Assert.assertEquals(5, instance.calculate("3+2*2/2"));
    Assert.assertEquals(11, instance.calculate("3+2*2/2+6"));
