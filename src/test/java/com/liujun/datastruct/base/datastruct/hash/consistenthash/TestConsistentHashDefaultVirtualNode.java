 ...
 * @version 0.0.1
 */
public class TestConsistentHashDefaultVirtualNode {

  @Test
  public void testDataPut() {
    ConsistentHashVirtualNodeDefault dataHash = new ConsistentHashVirtualNodeDefault();
    ...
    //再次设置默认节点
    dataHash.defaultNode("192.168.1.5");
    for (int i = 0; i < 100; i++) {
      String node = dataHash.getNode(RandomStringUtils.randomAlphabetic(10));
      System.out.println(node);
