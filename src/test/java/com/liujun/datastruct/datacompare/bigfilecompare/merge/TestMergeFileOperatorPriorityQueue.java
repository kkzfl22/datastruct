 ...
 * @version 0.0.1
 */
public class TestMergeFileOperatorPriorityQueue {
  ...
  public void mergeReader() {
    ...
    try (MergeFileOperatorPriorityQueue<FileDataTimeStampEntity> mergeReader =
        new MergeFileOperatorPriorityQueue<>(
