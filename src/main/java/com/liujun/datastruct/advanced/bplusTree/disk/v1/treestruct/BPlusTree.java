...
import com.liujun.datastruct.advanced.bplusTree.disk.v1.disk.ChunkStreamOperator;
import com.liujun.datastruct.advanced.bplusTree.disk.v1.disk.FileOperator;
import com.liujun.datastruct.advanced.bplusTree.disk.v1.disk.NodeCount;
import com.liujun.datastruct.advanced.bplusTree.disk.v1.disk.RootNodeOperator;
import com.liujun.datastruct.advanced.bplusTree.disk.v1.disk.SystemInfo;
...
public class BPlusTree {
  ...
  public BPlusTree(DataMetadata metadata, String path, String fileName) {
    ...
    // 根节持久华操作
    this.rootOperator = new RootNodeOperator(this, path);
    // 文件对象
    ...
    if (rootOperator.exists()) {
      this.rootOperator.readerRootNode();
    }
    // 如果当前块不存在，则进行创建操作
    else {
      // 最后写入数据的偏移量
      ...
      this.rootOperator.writeRootNode();
    }
  }
