 ...
 * @version 0.0.1
 */
public class DataCompareFileOutput {
  ...
  /** 增加数据内容 */
  private ManyFileWriteBase addFile;

  /** 修改的之前的数据内容 */
  private ManyFileWriteBase updateFileBefore;

  /** 修改的之后的数据的内容 */
  private ManyFileWriteBase updateFileAfter;

  /** 删除数据内容 */
  private ManyFileWriteBase deleteFile;
