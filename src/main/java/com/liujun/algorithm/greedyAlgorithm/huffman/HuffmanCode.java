...
public class HuffmanCode {
  ...
  public Map<Character, Byte> encodeHuf(Map<Character, String> parms) {

    Map<Character, Byte> result = new HashMap<>();
    for (Map.Entry<Character, String> entryItem : parms.entrySet()) {
      result.put(entryItem.getKey(), Byte.valueOf(entryItem.getValue(), 2));
    }

    return result;
  }

  public String parseHuffman(String src, Map<Character, Byte> huffman) {
